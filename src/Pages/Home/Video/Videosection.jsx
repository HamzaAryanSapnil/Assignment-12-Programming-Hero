            ...
            <div className="card  w-full h-full xl:h-[360px] bg-base-100 shadow-xl">
              <div className="card-body">
                ...
                <p className="font-mulish text-dark-03 text-cardDescolor">
                  ...
                  tradition. Click the button below as you discover the weave,
                  and carve. guiding you to our comprehensive All Tours page
                  where you can explore and acquire your own piece of artisanal
                  beauty.
                </p>
