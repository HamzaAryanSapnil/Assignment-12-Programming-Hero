      ...
      >
        ...
        <div className="hero-content text-neutral-content text-center">
          <div className="max-w-md">
            ...
            <p className="mb-5 text-xl text-start">
              Welcome to our Tourist Story Section. We are glad you are here.
              Here you can see some of our reviews. We have many of them. We
              will be very happy if you give us some feedback. For that you have
              to visit some where right? Please buy any package, visit there and
              give us some feedback. We will be happy to help you and will be
              very glad to share your own feedback in our website. Thank you.
              See ya!
            </p>
          </div>
        </div>
            ...
            >
              <div className="card bg-base-100 w-96 shadow-xl">
                ...
                <div className="card-body">
                  ...
                  <p className={toggleText ? "hidden" : "block"}>
                    {review?.storyDetailsReview.length > 100 ? (
                      <>
                        ...
                        <span className="link link-hover hover:cursor-pointer hover:text-primary">
                          <button
                            onClick={() => {
                              setReviewText(review?.storyDetailsReview);
